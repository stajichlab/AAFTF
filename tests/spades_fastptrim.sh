#!/bin/bash -l
#SBATCH -N 1 -n 48 -p short --mem 96gb  --out test_spades_fastptrim.%A.log
module load AAFTF
...
if [ ! -f $LEFT ]; then
	...
	../scripts/AAFTF trim --mem $MEM --method fastp --left $OUTDIR/${SRA}_1.fastq.gz \
