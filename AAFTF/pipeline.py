...
def run(parser, args):
    ...
    if not checkfile(rmdup_file):
        ...
        rmdup_args = create_namespace(rmdupOpts, required_args={"input": sourpurge_file, "out": rmdup_file, "minlen": args.mincontiglen, "percent_id": 95, "percent_cov": 95, "exhaustive": False, "pipe": True})
